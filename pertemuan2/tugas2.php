    ...
    <h2>Nilai Siswa</h2>
        ...
        <div class="form-group row">
            ...
            <select id="matkul" name="matkul" class="custom-select">
                ...
                <option value="PEMROGRAMAN WEB 2">Desain Grafis</option>
                <option value="JARINGAN KOMPUTER">UI/UX</option>
                <option value="BAHASA INGGRIS">Literasi Office</option>
                <option value="KOMUNIKASI EFEKTIF">Pemrograman Web</option>
            </select>
            </div>
        </div>
        <div class="form-group row">
