            ...
            <div class="col-12">
                <form method="POST" action="hasil.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <select id="matkul" name="matkul" placeholder="Matkul" class="custom-select">
                                <option value="Pemrograman Web">UI.UX</option>
                                <option value="Bahasa Inggris">Desain Grafis</option>
                                <option value="DDP">Literasi Office</option>
                                <option value="Basis Data">Ppkn</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
